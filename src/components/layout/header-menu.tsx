...
export default function Header(props: LayoutProps) {
	...
	const { data: accountData, mutate: refreshData } = useAccountInfo(
	...
	return (
		<header className={className}>
			<div
				className={
					styles.menu_bar + " d-flex items-center hide-menu-sp"
				}
			>
				<div className={styles.menu_left}>
					<div
						className={`${styles.logo} ${isDashboard ? styles.show_logo_sp : ""}`}
					>
						<IconKenkoukanri />
					</div>
				...
				{/* Filter and Download  */}
				<div
					className={`${styles.menu_list} ml-auto d-flex items-center relative`}
				>
              ...
              <>
                ...
                >
                  Google Analyticsに移動
						...
						{pathname === "/articles" && (
							<>
								<Link href="/articles/new">＋記事</Link>
							</>
						)}
						...
						{pathname === "/accounts" && (
							<>
								<Link href="/accounts/new">＋アカウント</Link>
							</>
						)}
						...
						{!isEntryPage &&
							...
							pathname !== "/" && (
								<div
									className={`${styles.filter_container} ${pageCtx.openFilterModal || articleListCtx?.isFilterActive ? styles.active : ""}`}
									onClick={() =>
										pageCtx.setOpenFilterModal(
											!pageCtx.openFilterModal,
										)
									}
								>
									<IconFilter />
					...
					>
						...
						<div className={styles.theme_container}>
							...
							<div className={styles.dark_mode}>
								<input
									...
									type="radio"
								/>
								<label htmlFor="theme-light-radio">
									ライトモード
								</label>
							</div>
							<div className={styles.light_mode}>
								<input
									...
									type="radio"
								/>
								<label htmlFor="theme-dark-radio">
									ダークモード
								</label>
							</div>
						</div>
						<div
							onClick={() =>
								signOut({
									callbackUrl:
										NEXT_PUBLIC_APP_URL + "/auth/signin",
								})
							}
